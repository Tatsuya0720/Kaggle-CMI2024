...
class CMIModel(nn.Module):
    def __init__(self, input_size, hidden_size, num_layers, dropout=0.0):
        ...
        # )
        self.table_encoder = TabNetModel(input_dim=table_input_size, output_dim=table_input_size)
        self.linear = nn.Linear(64+320, 1)
