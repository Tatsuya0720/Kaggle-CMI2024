...
class CMIModel(nn.Module):
    def __init__(self, input_size, hidden_size, num_layers, dropout=0.0):
        ...
        self.linear = nn.Linear(table_input_size+2560, 1)
...
class TimeEncoder(nn.Module):
    def __init__(self, input_size, hidden_size, num_layers, dropout=0.0):
        ...
        self.multihead_attention = MultiHeadAttention(embed_dim=2560, num_heads=4, dropout=0.0)
